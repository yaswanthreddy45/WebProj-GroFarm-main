...
export default class Login extends Component {
  constructor(props) {
    ...
    this.onChangeEmail = this.onChangeEmail.bind(this);
    this.onChangePassword = this.onChangePassword.bind(this);
    this.onChangeSeePassword = this.onChangeSeePassword.bind(this);
            ...
            >
              ...
              <Modal.Body>
                <form enctype="multipart/form-data">
                  ...
                  <input type = "checkbox" onChange={this.onChangeSeePassword} checked={this.state.showPassword}></input>
                  <input
